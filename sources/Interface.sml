...
fun updInput   {input = _, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} input   = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updOutput  {input, output = _, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} output  = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updLib     {input, output, lib = _, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} lib     = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updTime    {input, output, lib, time = _, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} time    = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updSub     {input, output, lib, time, sub = _, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} sub     = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updSanity  {input, output, lib, time, sub, sanity = _, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} sanity  = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updNuprl   {input, output, lib, time, sub, sanity, nuprl = _, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} nuprl   = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updObid    {input, output, lib, time, sub, sanity, nuprl, obid = _, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} obid    = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updAscii   {input, output, lib, time, sub, sanity, nuprl, obid, ascii = _, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} ascii   = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updEcheck  {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck = _, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} echeck  = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updTcheck  {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck = _, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} tcheck  = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updParse   {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse = _, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} parse   = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updSplit   {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split = _, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} split   = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updPrint   {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt = _, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} prt     = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updEval    {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval = _, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} eval    = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updAlldef  {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef = _, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} alldef  = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updTest    {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test = _, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} test    = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updSession {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session = _, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} session = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updSimul   {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul = _, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} simul   = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updStep    {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step = _, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} step    = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updMono    {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono = _, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} mono    = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updHost    {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host = _, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} host    = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updPort    {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port = _, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} port    = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updConf    {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf = _, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} conf    = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updClient  {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client = _, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} client  = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updClient2 {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2 = _, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} client2 = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updSend    {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send = _, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp} send    = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updOther   {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other = _, all, ev, id, extra, gc, file1, file2, monitor, tolisp} other   = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updAll     {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all = _, ev, id, extra, gc, file1, file2, monitor, tolisp} all     = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updEv      {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev = _, id, extra, gc, file1, file2, monitor, tolisp} ev      = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updId      {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id = _, extra, gc, file1, file2, monitor, tolisp} id      = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updExtra   {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra = _, gc, file1, file2, monitor, tolisp} extra   = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updGc      {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc = _, file1, file2, monitor, tolisp} gc      = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updFile1   {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1 = _, file2, monitor, tolisp} file1   = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updFile2   {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2 = _, monitor, tolisp} file2   = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updMonitor {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor = _, tolisp} monitor = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
fun updTolisp  {input, output, lib, time, sub, sanity, nuprl, obid, ascii, echeck, tcheck, parse, split, prt, eval, alldef, test, session, simul, step, mono, host, port, conf, client, client2, send, other, all, ev, id, extra, gc, file1, file2, monitor, tolisp = _} tolisp  = {input = input, output = output, lib = lib, time = time, sub = sub, sanity = sanity, nuprl = nuprl, obid = obid, ascii = ascii, echeck = echeck, tcheck = tcheck, parse = parse, split = split, prt = prt, eval = eval, alldef = alldef, test = test, session = session, simul = simul, step = step, mono = mono, host = host, port = port, conf = conf, client = client, client2 = client2, send = send, other = other, all = all, ev = ev, id = id, extra = extra, gc = gc, file1 = file1, file2 = file2, monitor = monitor, tolisp = tolisp}
...
fun format args =
    let fun gen [] r = r
	  ...
	  | gen (EVALCHECK      :: list) r = gen list (updEcheck  r true)
	  ...
	  | gen (CLIENT2        :: list) r = gen list (updClient2 r true)
...
fun is_cbv_extra     str = List.exists (fn EX_CBV      => true  | _ => false) (getExtra str)
...
fun get_ev "ev1" = ("1", ev1)
  ...
  | get_ev "ev2b"  = ("2b",  ev2b)
  | get_ev "2b"    = ("2b",  ev2b)
  | get_ev "ev2bn" = ("2bn", ev2bn)
  | get_ev "2bn"   = ("2bn", ev2bn)
  | get_ev "ev2e"  = ("2e",  ev2e)
  | get_ev "2e"    = ("2e",  ev2e)
  | get_ev "ev2d"  = ("2d",  ev2d)
  | get_ev "2d"    = ("2d",  ev2d)
...
fun evaluate_gen ev input str libop obid sub prt btyp extra =
    ...
    in let val (term, env, b) = E.slice [tmp] NONE libop 1 prt sub san btyp
	  ...
	  then let val s_term        = A.simplify term
		   ...
		   val cbv           = is_cbv_extra extra
		   val newprog       = true
		   val (n_terms1, _) = N.toNuprl lib tmp obid s_term env sub pref poly stdma btyp cbva cbv newprog
...
and run_help_session ev strm libop input obid sub btyp extra =
    let val _ = print ("\n"
		       ...
		       ^ "\n"
		       ^ "  - To change the evaluator, type one of these: ev1, ev2, ev2b, ev2bn, ev2e, ev2d, ev3, ev3b, ev3c, ev3d, ev4, ev4b, ev5, ev5b"
		       ^ "\n\n")
    in run_gen_session ev strm libop input obid sub btyp extra
    end
...
and run_session ev strm libop input obid sub btyp extra =
	...
	NONE => run_session ev strm libop input obid sub btyp extra
      ...
      | SOME "2b\n"       => run_ev_session ev2b "2b" strm libop input obid sub btyp extra
      | SOME "ev2bn\n"    => run_ev_session ev2b "2bn" strm libop input obid sub btyp extra
      | SOME "2bn\n"      => run_ev_session ev2b "2bn" strm libop input obid sub btyp extra
...
(* we dump the program in a file.  We create a new file if file1 and file2 are NONE *)
fun dump_prog n_terms prog fdump file1 file2 =
    let val output =
	    case (file1, file2) of
		(SOME output, _) => output
	      | (NONE, SOME output) => output
	      | (NONE, NONE) => "output-term-" ^ Time.toString (#stime (Posix.ProcEnv.times ()))
...
fun pp_dump_prog_op nterms (SOME (_, prog)) =
    dump_prog nterms prog NT.ppTerm NONE NONE
  | pp_dump_prog_op _ _ = ()

fun dump_prog_op nterms (SOME (_, prog)) file1 file2 extra =
    if is_unfold_extra extra
    then let val lib   = EV.get_lib ()
	     val prog' = NT.unfold_all lib prog
	     val _ = print ("[unfolding before dumping]\n")
	 in dump_prog [] prog' NT.toStringTerm file1 file2
	 end
    else let val _ = print ("[not unfolding before dumping]\n")
	 in dump_prog nterms prog NT.toStringTerm file1 file2
	 end
  | dump_prog_op _ _ _ _ _ = ()
...
fun toNuprl input outputop libop alldefop obid timelimit sub prt sprt poly btyp extra file1 file2 =
    let val san    = false
    ...
    in if b
       then let val s_term = A.simplify term
		...
		val cbv     = is_cbv_extra extra
		val newprog = true
		val (n_terms, prog) = N.toNuprl mapop input obid s_term env sub pref poly stdma btyp cbva cbv newprog
		(* -- Add programs to library -- *)
		val _  = EV.add_to_session n_terms
		val _  = set_program_op prog
		val _  =
		    if is_dump_extra extra
		    then dump_prog_op n_terms prog file1 file2 extra
		    else ()
		val st =
		    if prt
...
fun load_config_parse_messages msgs =
    map (fn (id, SOME (hdr, typ, body)) => IM.mk_message 0 id (mk_nuprl_message hdr typ body)
    	  | (id, NONE) => IM.mk_message 0 id NT.mk_axiom_term)
	msgs

fun load_config_parse config =
    let val _ = print_eml "loading parsing file"
	val (grps, conns, params, msgs) = C.parse config
...
fun getParams params map_params =
	...
	in map (fn param =>
		   case List.find (fn (id : string, _) => id = param) map_params of
		       SOME (id, v) =>
		       ((*print ("[param " ^ id ^ ": " ^ NT.toStringTerm v ^ "]\n");*)
			v)
		       ...
		       in case List.find (fn (i,_) => i = id) (!components) of
				  ...
				  val pop =
					 ...
					 then NONE
						 ...
						 (dump_prog [] ip NT.toStringTerm NONE NONE;
			      ...
			      in case pop of
					     ...
					     handle EVAL_ERROR str =>
						    (dump_prog [] ip NT.toStringTerm NONE NONE;
						     raise Fail ("run_stepper:evaluation_error("
								 ^ str
								 ^ "):cannot_recover"))
					 (*val _ = print "debugging: dumping"
					 val _ = dump_prog [] p' NT.toStringTerm*)
					 val _ = if debug
					 ...
					 val (s,msgs) = NT.dest_pair 4 p'
							handle err =>
							       (dump_prog [] p' NT.toStringTerm NONE NONE;
								raise err)
	      ...
	      in case !program of
			 ...
			 val (prog0,messages,args) =
			     ...
			     then let val _ = print_eml "trimming library"
				  ...
				  in (p, messages, args)
				      ...
				      val _ = app (fn msg => print ("\n--\n" ^ NT.toStringTerm (IM.message2term msg) ^ "\n--\n")) msgs
				      val _ = app (fn arg => print ("\n--\n" ^ NT.toStringTerm arg ^ "\n--\n")) args
				      val _    = print_eml ("size after unfolding: " ^ Int.toString (NT.size prog))
				      val _    = print_eml ("term stats: " ^ NT.stats_term_to_string prog)
				      val _    = if is_dump_extra extra then dump_prog [] prog NT.toStringTerm NONE NONE else ()
			 ...
			 val cmps =
			     map (fn (id,_,_) =>
					 ...
					 val (p,stps) = ev (~1) b
					     handle EVAL_ERROR str =>
						    (dump_prog [] b NT.toStringTerm NONE NONE;
						     raise Fail ("run_stepper:evaluation_error("
								 ^ str
								 ^ "):cannot_recover"))
...
and loop_stepper ev gc strm conf alldefs extra =
	...
	NONE => loop_stepper ev gc strm conf alldefs extra
      ...
      | SOME "2b\n"       => loop_ev_stepper ev2b "2b" gc strm conf alldefs extra
      | SOME "ev2bn\n"    => loop_ev_stepper ev2b "2bn" gc strm conf alldefs extra
      | SOME "2bn\n"      => loop_ev_stepper ev2b "2bn" gc strm conf alldefs extra
	    ...
	    then let val _ = if Option.isSome outputop
		 ...
		 in case terms of
			...
			in ()
		     ...
		     val _ = toNuprl input outputop lib alldefs obid time sub prt sprt poly btyp extra NONE NONE
		 in ()
		 end
	val _  =
...
fun load_program ev gc ident params loc extra =
	...
	let val args  = getParams prms params
	    ...
	    val prog3 =
		if is_fold_extra extra orelse not (is_unfold_extra extra)
		then let val _   = print_eml_id loc "trimming library"
			 val lib = EV.get_lib ()
			 val _   = NT.trim_lib_terms lib [prog2]
			 val _   = NT.print_lib_stats lib
			 val _   = if gc then MLton.GC.collect() else ()
		     in prog2
		     end
	    ...
	    val _     = print_eml_id loc "applying parameters"
	    ...
	    (* -- *)
	    val _     = print_eml_id loc "partial evaluation"
...
(* we want a socket descriptor so that we can do a select *)
...
fun wait_before_sending loc delay =
    let val time = Time.fromMilliseconds (LargeInt.fromInt delay)
    in if delay > 0
       then let val _ = print_eml_id loc ("sending message in " ^ Int.toString delay ^ "ms")
...
fun old_send_message id sock desc loc delay msg =
...
fun combine_len_and_msg slen slice =
    Word8VectorSlice.full (Word8VectorSlice.concat [slen, slice])
    ...
    in if 0 < delay
       then case Posix.Process.fork () of
		...
		print_eml_id id "forked, child will send the message"
	      | NONE => (* child *)
		let val _  = wait_before_sending id delay
		    val sl = combine_len_and_msg slen slice
		    val _  = send_something id sock desc sl
		in OS.Process.exit OS.Process.success
		end
       else let val sl = combine_len_and_msg slen slice
		val _  = send_something id sock desc sl
	    in ()
	    end
    end
...
fun old_send_nuprl_internal_message loc outfd delay msg =
    ...
    in if 0 < delay
       then case Posix.Process.fork() of
		...
		let val _  = wait_before_sending loc delay
		    val sl = combine_len_and_msg slen slice
		    val _  = send sl
			handle err => (print_eml_id loc ("sending of message failed (" ^ slice_to_string sl ^ ")");
				       raise err)
		in OS.Process.exit OS.Process.success
		end
		handle _ =>
  ...
  | receive_messages loc sockets =
    (case #rds (Socket.select {rds = get_descs sockets, wrs = [], exs = [], timeout = NONE}) of
	 [] => raise Fail "receive_message:select:nil"
       | descs =>
	 let val len = length descs
	     val _ = print_eml_id loc ("--ready to receive from " ^ Int.toString len ^ " sockets")
...
fun receive_message' loc sockets =
    let val (msgs,_,_) = receive_messages loc sockets
    in msgs
    end
...
fun get_non_halted_prog extra prog =
    ...
    then NONE
    else (dump_prog [] prog NT.toStringTerm NONE NONE;
...
fun run_distributed_program2 ev gc ident config spec lib alldefs prt extra =
	...
	fun loop sockets (SOME prog) (*n*) =
		...
		val (msgs_str,_,sockets') = receive_messages loc sockets
...
fun simulate_clients_server config prt =
	...
	fun loop sockets =
	    let val (msgs_str,_,sockets') = receive_messages "client" sockets
...
fun mkmsgs n cid =
    if n = 0 then []
    else let val c = Int.toString (!cid)
	     val _ = cid := !cid + 1
	 in "rep1 : (``bcast``, (Int * Tok List), (" ^ c ^ ",``" ^ c ^ "``))" :: mkmsgs (n - 1) cid
	 end

fun simulate_clients_send_aux strm cid aux =
    case TextIO.inputLine strm of
	NONE       => aux NONE
      | SOME ""    => aux NONE
      | SOME "\n"  => aux NONE
	...
	in aux (SOME ["rep1 : (``bcast``, (Int * Tok List), (" ^ c ^ ",``" ^ c ^ "``))"])
      ...
      | SOME "c10\n" => aux (SOME (mkmsgs 10 cid))
      | SOME "c50\n" => aux (SOME (mkmsgs 50 cid))
      | SOME "c100\n" => aux (SOME (mkmsgs 100 cid))
      | SOME "c500\n" => aux (SOME (mkmsgs 500 cid))
      | SOME "p\n" =>
	let val c = Int.toString (!cid)
	    val _ = cid := !cid + 1
	in aux (SOME ["ldr1 : (``propose``, (Int * Tok List), (" ^ c ^ ",``" ^ c ^ "``))"])
	end
      | SOME "gc\n" => aux (SOME ["rep1 : (``gc``, Unit, ())", "rep2 : (``gc``, Unit, ())"])
      | SOME "dbg\n" => aux (SOME ["rep1 : (``dbg``, Unit, ())", "rep2 : (``dbg``, Unit, ())"])
      | SOME msg => aux (SOME [msg])

fun simulate_parse_lib alldefop prt =
    case alldefop of
	SOME f =>
	let val _     = print_eml "parsing Nuprl library"
	    val light = false
...
fun simulate_clients_send config alldefop prt gc =
    let	val lib  = simulate_parse_lib alldefop prt
	val strm = TextIO.stdIn
	val cid  = ref 1
	fun aux msgop =
		...
		val msgs =
		    case msgop of
			NONE => msgs
		      | SOME msgs => load_config_parse_str (String.concatWith " " msgs)
		...
		val _    = print "send? "
	    in simulate_clients_send_aux strm cid aux
	    end
	val _ = print "send? "
    in simulate_clients_send_aux strm cid aux
    end

fun simulate_clients_send_and_receive extra ident config alldefop prt gc =
    let val (groups,_,_,_) = load_config_parse config
	...
	val _       = print_eml_id loc "connected"
	val lib     = simulate_parse_lib alldefop prt
	val strm    = TextIO.stdIn
	val cid     = ref 1
	val _       = print "send? "
	fun loop sockets n m =
	    if m < n then ()
	    else
		let (* sending *)
		    val msg    = case load_config_parse_str (String.concatWith " " ["rep1 : (``bcast``, (Int * Tok List), (" ^ Int.toString n ^ ",``" ^ Int.toString n ^ "``))"]) of
				      [msg] => msg
				    | _ => raise Fail "more than 1 message"
		    (*val time   = Time.toMilliseconds (Time.now ())*)
		    (*val _      = print_eml_id loc ("unfolding message(" ^ LargeInt.toString time ^ "ms)")*)
		    val outmsg = unfold_intransit_message lib msg
		    (*val _      = print_eml_id loc ("unfolded message")*)
		    (*val _      = print_eml_id loc ("GC...")*)
		    val _      = if gc then MLton.GC.collect () else ()
		    (*val _      = print_eml_id loc ("GC done")*)
		    val (delay,id,msg) = IM.dest_message outmsg
		    val time   = Time.toMilliseconds (Time.now ())
		    val _      = print_eml_id loc ("sending intransit message(" ^ LargeInt.toString time ^ "ms)")
		    (*val _      = print_eml_id loc ("message: (" ^ NT.ppTerm msg)*)
		    val _      = send_nuprl_external_message loc sockets id delay msg
		    (*val _      = print_eml_id loc "message sent"*)
		    (* receiving *)
		    val _ = print_eml_id loc "waiting to receive messages"
		    val (msgs_str1,len1,sockets1) = receive_messages "client" sockets
		    val (msgs_str2,sockets2) =
			if len1 = 1
			then let val _ = print_eml_id loc "waiting to receive 2nd message"
				 val (msgs_str2,len2,sockets2) = receive_messages "client" sockets1
			     in if len2 = 1 then (msgs_str1 ^ msgs_str2, sockets2)
				else raise Fail "#responses <> 2"
			     end
			else if len1 = 2 then (msgs_str1,sockets1)
			else raise Fail "#responses <> 2"
		    val msgs = parse_message_debug 6 msgs_str2 prt
		    val time = Time.toMilliseconds (Time.now ())
		    val _    =
			print ("\n-------------\n"
			       ^ "received(" ^ LargeInt.toString time ^ "ms): "
			       ^ (ListFormat.fmt {init  = "",
						  final = "",
						  sep   = "\n--\n",
						  fmt   = NT.nuprlTerm2eml}
...
fun run_other_machine extra ident config prt =
	...
	fun internal sockets =
	    let val (msgs_str,_,sockets') = receive_messages loc sockets
		val time = Time.toMilliseconds (Time.now ())
...
fun dest_captured_computation term =
    let val ((opid,params),bterms) = NT.dest_term term
    in case (params, bterms) of
	   ([oc, uc, t], [([], oterm), ([], ores), ([], uterm), ([], ures)]) =>
	   if opid = "captured_computation"
	   then let val oc = Option.valOf (Int.fromString (NT.value_of_parameter oc))
		    val uc = Option.valOf (Int.fromString (NT.value_of_parameter uc))
		in (oc,
		    uc,
		    NT.rterm2term oterm,
		    NT.rterm2term ores,
	   ...
	   else raise Fail "dest_captured_computation:wrong_format"
	 | _ => raise Fail "dest_captured_computation:wrong_format"
    end

fun print_tests [] = ()
  | print_tests (term :: terms) =
    let val (oc, uc, oterm, ores, uterm, ures) = dest_captured_computation term
    in (print ("-----------------------\n"
	       ^ "computation:"
	       ^ "(" ^ Int.toString oc ^ ")"
	       ^ "(" ^ Int.toString uc ^ ")"
	       ^ "\n"
	       ^ "  " ^ NT.toStringTerm oterm
	       ^ "\n"
	       ^ "  " ^ NT.toStringTerm ores
	       ^ "\n"
	       ^ "  " ^ NT.toStringTerm uterm
	       ^ "\n"
	       ^ "  " ^ NT.toStringTerm ures
	       ^ "\n");
	print_tests terms)
    end

fun eval_check_terms n ev [] = ()
  | eval_check_terms n ev (term :: terms) =
    let val stn = Int.toString n
	val (oc, uc, oterm, ores, uterm, ures) = dest_captured_computation term
	(* -- oterm --*)
	val (oterm',osteps) = ev oc oterm
	    handle EVAL_ERROR str => raise Fail ("evaluation error:" ^ str)
	(*val _ = print ("[" ^ Int.toString oc ^ " " ^ Int.toString osteps ^ "]\n")*)
	val coterm' = NT.close oterm' NT.em_env
	val _ =
	    (if (NT.alpha_eq_terms ores coterm'; true)
	     then print ("[test " ^ stn ^ "(O): OK]\n")
	     else (print ("[test " ^ stn ^ "(O): FAILED]\n");
		   print ("should get:\n");
		   print (NT.toStringTerm ores ^ "\n");
		   print ("got:\n");
		   print (NT.toStringTerm coterm' ^ "\n");
		   (*print ("unclosed:\n");
		    print (NT.toStringTerm oterm' ^ "\n");*)
		   raise Fail ("test " ^ stn ^ " failed")))
	(* -- uterm --*)
	val (uterm',usteps) = ev uc uterm
	    handle EVAL_ERROR str => raise Fail ("evaluation error:" ^ str)
	(*val _ = print ("[" ^ Int.toString uc ^ " " ^ Int.toString usteps ^ "]\n")*)
	val cuterm' = NT.close uterm' NT.em_env
	val _ =
	    if (NT.alpha_eq_terms ures cuterm'; true)
	    then print ("[test " ^ stn ^ "(U): OK]\n")
	    else (print ("[test " ^ stn ^ "(U): FAILED]\n");
		  print ("should get:\n");
		  print (NT.toStringTerm ures ^ "\n");
		  print ("got:\n");
		  print (NT.toStringTerm cuterm' ^ "\n");
		  (*print ("unclosed:\n");
		  print (NT.toStringTerm uterm' ^ "\n");*)
		  raise Fail ("test " ^ stn ^ " failed"))
    in eval_check_terms (n + 1) ev terms
    end

fun eval_check file ev alldefs prt split extra =
    let val light = true
	val _     = print "[switching to call-by-name evalutor 2]\n"
	val ev    = ev2bn
	val _     = print "[loading library]\n"
	val _     = EV.start_session true alldefs
	val _     = print ("[parsing input test file: " ^ file ^ "]\n")
	val terms = PN.parse prt light NT.to_filter_out file split
	val _     = print "[checking]\n"
    in eval_check_terms 1 ev terms
    end
...
fun run args =
    let val {input,   output,  lib,     time,    sub,      sanity,
	     ...
	     client2, send,    other,   all,     ev,       id,
	     extra,   gc,      file1,   file2,   monitor,  tolisp,
	     echeck} = format args
    ...
    in if tolisp
       ...
       then (toNuprl input output lib alldef obid time sub prt (true, true) poly btyp extra file1 file2; ())
       else if echeck
       then eval_check input ev alldef prt split extra
       else if ascii
       ...
       then let val config = Option.valOf conf
	    in if simul
	       ...
	       then simulate_clients_send_and_receive extra ident config alldef prt gc
	       else if send
