...
fun toStringProd SCON_INT    = "SCON_INT"
  ...
  | toStringProd ATEXP_LOCAL   = "ATEXP_LOCAL"
  ...
  | toStringProd DEC_SVCLASS  = "DEC_SVCLASS"
...
fun export (N {kind = (SCON, SCON_INT),    label, value, regions, parents, children = []}) = value
  ...
  | export (N {kind = (EXP, EXP_N2I),      label, value, regions, parents, children = [e]})           = export e ^ "#"
  ...
  | export (N {kind = (ATEXP, ATEXP_LOCAL),   label, value, regions, parents, children = [e1,e2,e3]}) = "Local("   ^ export e1 ^ "," ^ export e2 ^ "," ^ export e3 ^ ")"
  ...
  | export (N {kind = (DEC, DEC_SVCLASS),  label, value, regions, parents, children = [b]})             = "class* "    ^ export b
...
fun getIdentsDec (dec as N {kind = (DEC, DEC_LET),      label, value, regions, parents, children = [b]})             = getIdentsBind b
  ...
  | getIdentsDec (dec as N {kind = (DEC, DEC_SVCLASS),  label, value, regions, parents, children = [b]})             = getIdentsBind b
...
and simplifyDec (term as N {kind = (DEC, DEC_LET),     label, value, regions, parents, children = [b]})              =
  ...
  | simplifyDec (term as N {kind = (DEC, DEC_SVCLASS),  label, value, regions, parents, children = [b]})              =
    if value = ""
    then simplifyDec (mk_term DEC_LET label "*SV*" regions parents [b])
    else raise Fail ("simplifyDec:DEC_SVCLASS:value(" ^ value ^ ")")
