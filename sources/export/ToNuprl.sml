 ...
 * The Boolean is true if the id is an include *)
val userFP = ref (CONS.empty : (string list * bool) CONS.map)
fun addUserFP id params = userFP := CONS.insert (!userFP, id, (params, false))
fun addIncFP id params = userFP := CONS.insert (!userFP, id, (params, true))
...
(* The Boolea n is true if the term is an include.  If it's an include
 * we shouldn't prefix the prefix *)
fun mk_nuprl_user_term_lvlop opid terms lvlop b =
    let val obid    = getObid ()
	val name    = if b then opid else get_user_name opid
...
fun mk_nuprl_user_term opid terms b = mk_nuprl_user_term_lvlop opid terms NONE b
 ...
 * 1st term    : program
 * 2nd term    : class abstraction
 * 3rd term    : program abstraction *)
type map_fprog = (string
		  * string list
		  * NT.nuprl_term
		  * NT.nuprl_term
		  * NT.nuprl_term option) FPROGS.map
...
type context =
     {progs   : map_progs,
      ...
      cbv     : bool,  (* True (False is default) to convert lets into cbv lets and not lazy ones *)
...
fun get_cbv_context     (context : context) = #cbv     context
fun get_prop_context    (context : context) = #prop    context

fun set_progs_context   {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context x     fprogs arity params eqdec bounds data ndefs poly extra addpref base nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_fprogs_context  {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs x      arity params eqdec bounds data ndefs poly extra addpref base nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_arity_context   {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs x     params eqdec bounds data ndefs poly extra addpref base nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_params_context  {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity x      eqdec bounds data ndefs poly extra addpref base nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_eqdec_context   {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params x     bounds data ndefs poly extra addpref base nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_bounds_context  {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec x      data ndefs poly extra addpref base nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_data_context    {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds x    ndefs poly extra addpref base nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_ndefs_context   {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data x     poly extra addpref base nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_poly_context    {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs x    extra addpref base nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_extra_context   {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly x     addpref base nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_addpref_context {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra x       base nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_base_context    {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref x    nlp inv typ states exports hyps fabs decs cbva cbv prop
fun set_nlp_context     {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref base x   inv typ states exports hyps fabs decs cbva cbv prop
fun set_inv_context     {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref base nlp x   typ states exports hyps fabs decs cbva cbv prop
fun set_typ_context     {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref base nlp inv x   states exports hyps fabs decs cbva cbv prop
fun set_states_context  {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref base nlp inv typ x      exports hyps fabs decs cbva cbv prop
fun set_exports_context {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref base nlp inv typ states x       hyps fabs decs cbva cbv prop
fun set_hyps_context    {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref base nlp inv typ states exports x    fabs decs cbva cbv prop
fun set_fabs_context    {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref base nlp inv typ states exports hyps x    decs cbva cbv prop
fun set_decs_context    {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref base nlp inv typ states exports hyps fabs x    cbva cbv prop
fun set_cbva_context    {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref base nlp inv typ states exports hyps fabs decs x    cbv prop
fun set_cbv_context     {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref base nlp inv typ states exports hyps fabs decs cbva x   prop
fun set_prop_context    {progs, fprogs, arity, params, eqdec, bounds, data, ndefs, poly, extra, addpref, base, nlp, inv, typ, states, exports, hyps, fabs, decs, cbva, cbv, prop} x = mk_context progs fprogs arity params eqdec bounds data ndefs poly extra addpref base nlp inv typ states exports hyps fabs decs cbva cbv x
...
fun add_file_prog_context context _ NONE = context
  | add_file_prog_context context file (SOME (params, prog, classabs, progabs)) =
    let val {dir, file} = OS.Path.splitDirFile file
	val {base, ext} = OS.Path.splitBaseExt file
	val pref   = getPrefix ()
	val info   = (pref, params, prog, classabs, progabs)
	val fprogs = FPROGS.insert (get_fprogs_context context, base, info)
	val ctxt   = set_fprogs_context context fprogs
	val _      = print ("[added file " ^ file
			    ^ " with prefix " ^ pref
			    ^ " and parameters [" ^ String.concatWith "," params ^ "]"
			    ^ "]\n")
    in ctxt
    end
...
val is_cbv_context  = get_cbv_context
...
fun reset_cbv_context     context = set_cbv_context     context false
...
fun is_maybe_state_term term =
    ...
    in NT.is_nuprl_term "State-comb" t
       ...
       orelse NT.is_nuprl_term "state-class5" t
    end
...
fun set_hidden_msg_fun context term =
    let val f     = A.newIdIdSet (A.getIdentsTerm term) "mf"
...
fun mk_nuprl_hidden_msg_fun n force =
	...
	val params =
		...
		case getUserFP (fn x => false) typ_name of
		    NONE =>
		    if force
		    then let val _ = print ("[WARNING:have not found message function in context but forcing its use]\n")
			 in []
			 end
		    else raise Fail ("mk_nuprl_hidden_msg_fun:header_function_type_not_declared:" ^ typ_name ^ ":" ^ Int.toString n)
		  | SOME (params, b) => params
	val _ = addDecFP f
...
fun mk_force var mf rm =
    {force_var  = var,
     force_mf   = mf,
     force_rmmf = rm}

fun get_force_var  ({force_var,  ...} : force) = force_var
fun get_force_mf   ({force_mf,   ...} : force) = force_mf
fun get_force_rmmf ({force_rmmf, ...} : force) = force_rmmf

val default_force_var  = false
val default_force_mf   = false
val default_force_rmmf = false
val default_force  = mk_force default_force_var default_force_mf default_force_rmmf
val mk_force_var   = mk_force true              default_force_mf default_force_rmmf
val mk_force_mf    = mk_force default_force_var true             default_force_rmmf
val mk_force_mf_rm = mk_force default_force_var true             true

fun force2string {force_var,force_mf,force_rmmf} =
    "(" ^ Bool.toString force_var  ^
    "," ^ Bool.toString force_mf   ^
    "," ^ Bool.toString force_rmmf ^ ")"

fun mk_nuprl_hidden_msg_fun_def n = mk_nuprl_hidden_msg_fun n default_force_mf
...
val default_message_fun_type =
    let val type_name = NT.mk_nuprl_name_term
	val typi      = NT.mk_nuprl_type_term "i"
    in NT.mk_fun_term type_name typi
    end
...
fun toNuprlIty i force addctxt context vars (E.ITYVAR (ityvar, eq)) ityvarset etyvarset =
  ...
  | toNuprlIty i force addctxt context vars (E.ITYCON (E.ITYSEQSEQ (itys, _), E.ITYCONNAM (tyconnam, _, _))) ityvarset etyvarset =
    ...
    in case (tyconnam, n_itys) of
	 ...
	 | ("Class",     [nt]) => NT.mk_nuprl_class_term (mk_nuprl_hidden_msg_fun 1 (get_force_mf force)) nt
	 | ("Bag",       [nt]) => NT.mk_nuprl_bag_term   nt
	 | ("Deq",       [nt]) => NT.mk_nuprl_deq_term   nt
	 | ("Int",       []) => NT.mk_int_term
	 | ("Bool",      []) => NT.mk_nuprl_bool_term
	 | ("Real",      []) => NT.mk_nuprl_real_term
	 | ("Msg",       []) => NT.mk_nuprl_msg_term (mk_nuprl_hidden_msg_fun 2 (get_force_mf force))
	 | ("Interface", []) => NT.mk_nuprl_interface_term (mk_nuprl_hidden_msg_fun 3 (get_force_mf force))
	 ...
	 | ("_EO",       []) => NT.mk_nuprl_event_orderingp_term "i" (mk_nuprl_hidden_msg_fun 4 (get_force_mf force))
	 | ("_MSGFUN",   []) =>
	   (case get_header_function_type () of
		...
		case getUserFP (is_bound_context context) typ_name of
		    NONE =>
		    if get_force_mf force
		    then let val _ = print ("[WARNING:have not found message function in context but forcing its use]\n")
			 in default_message_fun_type
			 end
		    else raise Fail "_MSGFUN:header_function_type_not_declared"
		  | SOME (params, b) =>
		    let val aterms = map NT.mk_variable_term params
			val _      = addDecFPList params
			val lvlop  = SOME "i"
		    in mk_nuprl_user_term_lvlop typ_name aterms lvlop b
		    end)
	 ...
	 | (tycon, args) =>
	   (case is_data_context context tycon of
		...
		in if List.null args
		   then mk_nuprl_user_term tycon a_terms false
...
fun toDeq context (E.ITYVAR (ityvar, eq)) =
  ...
  | toDeq context (E.ITYCON (E.ITYSEQSEQ (itys, _), E.ITYCONNAM (tyconnam, _, _))) =
    let fun toIty ity = toNuprlIty_em 0 default_force context (E.stripIty ity)
...
fun toNuprlScheme context (E.VPOLY ((ityvarset, etyvarset, idorset), (overseq, ity))) =
	...
	val add   = true
	val n_ity = toNuprlIty 1 default_force add context IDENTS.empty ity' ren etyvarset
    in (n_ity, nts2 @ nts1)
    end
...
fun schemeParamToHead context (force : force) (E.VPOLY ((ityvarset, etyvarset, idorset), (overseq, ity))) =
    let val ity'  = E.stripIty ity
  ...
  | schemeParamToHead context force (E.VODEC _) = raise Fail "impossible:overloaded schemes are not allowed to be converted into NuPrl"
  | schemeParamToHead context force (E.VMONO _) = raise Fail "impossible:monomorphic schemes are not allowed to be converted into NuPrl"
...
fun findNlpsInType term typ (args, set) =
    ...
    in if opid = "eclass"
       then let val (_, _, _, Y) = NT.dest_eclass typ
		val nlp = NT.mk_nuprl_nlp_term (mk_nuprl_hidden_msg_fun_def 5) Y term
		val prg = NT.mk_nuprl_programmable_term (mk_nuprl_hidden_msg_fun_def 6) Y term
	    in ([(nlp, prg)], args, set)
	    end
...
fun genNormLocProg set class nity cls args =
    ...
    in if opid = "eclass"
       then let val (msg, es, e, X) = NT.dest_eclass nity
		...
		val nlp      = NT.mk_nuprl_nlp_term (mk_nuprl_hidden_msg_fun_def 7) X applies
		val prg      = NT.mk_nuprl_programmable_term (mk_nuprl_hidden_msg_fun_def 8) X applies
		...
		val (nlpsimp', prgsimp') =
		    foldr (fn ((param, typ), (rightN, rightP)) =>
				  ...
				  val nlp     = NT.mk_nuprl_nlp_term (mk_nuprl_hidden_msg_fun_def 9) typ term
				  val prg     = NT.mk_nuprl_programmable_term (mk_nuprl_hidden_msg_fun_def 10) typ term
...
fun genLocClassStmtArg set term typ =
    ...
    in if opid = "eclass"
       then let val (_,_,_,T) = NT.dest_eclass typ
		...
		val typ'   = NT.mk_nuprl_local_class_msg_term (mk_nuprl_hidden_msg_fun_def 11) T term'
...
fun genLocClassStmt
	...
	n_typ
	cls_params
	(args   : (NT.variable * NT.nuprl_term) list)
	alls
	(prog   : NT.nuprl_term)
	(lc_abs : NT.nuprl_term) =
    let (*val _ = print ("[#classes:" ^ Int.toString (length cls_params) ^ "]\n")*)
	val opid = NT.opid_of_term n_typ
    in if opid = "eclass"
       then let val (msg,es,e,T) = NT.dest_eclass n_typ
		val setvars = getVariablesNuprlType T
		val vars    = SETVARS.listItems setvars
		val loctyp  = NT.mk_nuprl_local_class_msg_term (mk_nuprl_hidden_msg_fun_def 12) T class
		val typ     =
		    foldr (fn ((v,T),typ) => NT.mk_nuprl_all_term T (v,typ))
			  loctyp
			  alls
		val (args',prog',set',lc_abs') =
		    foldr (fn ((v,T),(args,prog,set,lc_abs)) =>
			      let val pr      = A.newIdIdSet set ("pr" ^ v)
				  (*val _       = print ("[new param class pr: " ^ pr ^ ", type: " ^ NT.toStringTerm T ^ "]\n")*)
				  ...
				  val lc_abs' = NT.fo_subst [(NT.mk_new_nuprl_var v,tpr)] lc_abs
				  val loc     = NT.mk_nuprl_local_class_msg_term (mk_nuprl_hidden_msg_fun_def 13) T tv
				  val cls     = NT.mk_nuprl_class_term (mk_nuprl_hidden_msg_fun_def 14) T
				  val args'   = (v,cls) :: (pr,loc) :: args
			      in (args',prog',set',lc_abs')
			      end)
			  (args,prog,set,lc_abs)
			  cls_params
		val mem  = NT.mk_nuprl_member_term typ lc_abs'
		val uall =
		    foldr (fn ((v,T),uall) =>
			      let (*val _ = print ("[binding: " ^ v ^ "]\n")*)
			      in NT.mk_nuprl_uall_term T (v,uall)
			      end)
			  mem
			  args'
		val binders = map (fn (a,b) => a) args'
	    in SOME (binders,vars,uall,prog',lc_abs')
	    end
       else if opid = "function"
...
fun getScheme context id lab poly msg : E.scheme =
    if get_typ_context context
...
fun is_functional_class context term =
    ...
    in if opid = "State1"
	  ...
	  orelse opid = "memory-class1"
       ...
       else if opid = "state-class4"
       then let val X1 = NT.subtermn 3 term
		val X2 = NT.subtermn 5 term
		val X3 = NT.subtermn 7 term
		val X4 = NT.subtermn 9 term
		val X5 = NT.subtermn 11 term
	    in is_single_valued_list context [X1, X2, X3, X4, X5]
	    end
       else false
    end
...
fun reorder_parameters' force [] params rest = params @ rest
  | reorder_parameters' force (x :: xs) params rest =
    if x = !hidden_event_ordering
    then reorder_parameters' force xs params (x :: rest)
    else if x = !hidden_msg_fun
    then if get_force_rmmf force
	 then reorder_parameters' force xs params rest
	 else reorder_parameters' force xs params (rest @ [x])
    else reorder_parameters' force xs (params @ [x]) rest

fun reorder_parameters force params = reorder_parameters' force params [] []

fun reorder_typed_parameters binders [] = []
  | reorder_typed_parameters binders [(p,(ty,nts,propop))] =
    let val vars = NT.get_free_vars ty
    in if List.all (fn v => List.exists (fn x => x = v) binders) vars
       then [(p,(ty,nts,propop))]
       else raise Fail ("[reodering parameters: " ^ p ^ " has a free variable]\n")
    end
  | reorder_typed_parameters binders ((p,(ty,nts,propop)) :: (a,b) :: prms) =
    let val vars = NT.get_free_vars ty
    in if List.all (fn v => List.exists (fn x => x = v) binders) vars
       then (p,(ty,nts,propop)) :: reorder_typed_parameters (p :: binders) ((a,b) :: prms)
       else let val lst = reorder_typed_parameters (a :: binders) ((p,(ty,nts,propop)) :: prms)
	    in reorder_typed_parameters binders ((a,b) :: lst)
	    end
    end
 ...
 *)
fun genAbstractionAndWF
	(i : int)
	context
	(force : force)
	value id lab n_exp exp
	schemeop premises programmable
	localclass data lvlop =
	...
	val no_ord_parms = getDecFP ()
	val ord_parms = reorder_parameters force no_ord_parms
	val no_ord_typarms =
	    map (fn param =>
		    case get_param_context context param of
			SOME (scheme, kind, propop) =>
			let (*val _ = print ("[param:" ^ param ^ "]\n")
			    val _ = print ("[force:" ^ force2string force ^ "]\n")*)
			    val (n_ity, nts) = schemeParamToHead context force scheme
			...
			raise Fail ("genAbstractionAndWF"
				    ...
				    ^ ")"))
	 	ord_parms
	val nprms0 = reorder_typed_parameters [] no_ord_typarms
	val parms = map (fn (a,b) => a) nprms0
	...
	val n_id   = mk_nuprl_user_term_lvlop id n_prs lvlop false
	...
	fun toUAllPrms binders term =
	    foldr (fn ((param, (nity, nts, propop)), n_term) =>
		      if List.exists (fn x => x = param) binders
		      then n_term
		      else foldr (NT.mk_nuprl_uall_term n_typ)
				 (let val typ =
					  if NT.is_nuprl_type_term nity
					  then n_atyp
					  else nity
	...
	val functional =
		...
		let val set     = get_all_ids_list [t,T]
		    ...
		    val qs2     = [(es, NT.mk_nuprl_event_orderingp_term "i" (mk_nuprl_hidden_msg_fun_def 15), false)]
		    val qs'     = qs @ qs2 @ qs1
		    ...
		    val fun_id  = mk_nuprl_user_term_lvlop (id ^ "Fun") fun_prm lvlop false
	...
	val (extras, prog_abs) =
	    case localclass of
		SOME prog =>
		let val lc_abs = mk_nuprl_user_term_lvlop (id ^ "-program") n_prs lvlop false
		in case genLocClassStmt set n_id n_ity nprms_cls [] [] prog lc_abs of
		       SOME (binders,vars,all,prog',lc_abs') =>
		       let val all1 =
			       foldr (fn (v, all) =>
					 if List.exists (fn x => x = v) vars
				     ...
				     all
				     bounds
			   val all2    = toUAllPrms binders all1
...
fun genAbstractionAndWF' i context force value id lab n_exp exp premises =
...
fun genAbstractionAndWFDots i context force value id lab n_exp premises =
    genAbstractionAndWF' i context force value id lab n_exp dummy_dot_term premises
...
fun genInvariant context name cls (pairs, args) vals wclsop Xop (nprop, prop) T ren single_val =
	...
	val assumptions =
	    map (fn hyp =>
			...
			let val a_terms = map NT.mk_variable_term params
			    val _ = addDecFPList params
			in mk_nuprl_user_term hyp a_terms false
			end)
	...
	val parms0 = getDecFP ()
	val _      = addDecFPList (get_params_set_types context (getDecFP ()))
	val parms  = reorder_parameters default_force (getDecFP ())
	val (ncls,mapargs) =
	...
	val nprms0 = map (fn param =>
			     case get_param_context context param of
				 SOME (scheme, kind, propop) =>
				 let val (n_ity, nts) = schemeParamToHead context default_force scheme
				 in (param, (n_ity, nts, propop))
				 end
	...
	val (exop, set) =
		...
		let val ity = getItyAtLab context (A.getLabel ident) ""
		    val add = true
		    val nty = toNuprlIty 21 default_force add context IDENTS.empty (E.stripIty ity) ren E.emptyETVS
	...
	val term2  =
	    NT.mk_nuprl_all_term
		(NT.mk_nuprl_event_orderingp_term "i" (mk_nuprl_hidden_msg_fun_def 16))
		(eo, term1)
	val term3  =
	    foldr (fn ((param, (nity, nts, propop)), n_term) =>
...
fun preToNuprlCombComp context (n_exp, n_prg) exps bprior opt label blift bconcat =
    if blift andalso bconcat andalso not bprior andalso not (Option.isSome opt)
    then case exps of
...
fun class2prog context label class =
	...
	let val id  = NT.opid_of_term class
		...
		then case E.destClassType ity' of
			 SOME cls => class2newprog_tr context abs class
		       | NONE => class
		else class
	in prog
	end
...
fun mk_base_class context set ident atm typ hdr =
	...
	val prog = NT.mk_nuprl_base_class_program_term atm
	val schemeop     = NONE
	val premises     = []
	val programmable = false
...
fun mk_verify_class context set ident atm typ hdr =
    let val id   = A.getIdIdent ident ^ "'verify"
	val lab  = A.getLabel ident
	val term = NT.mk_nuprl_verify_class_term atm
	val prog = NT.mk_nuprl_verify_class_program_term atm
	val schemeop     = NONE
	val premises     = []
	val programmable = false
	val localclass   = SOME prog
...
fun mk_sign_function context set ident atm typ hdr =
    let val id       = A.getIdIdent ident ^ "'sign"
	val lab      = A.getLabel ident
	val v        = A.newIdIdSet set "z"
	val l        = A.newIdIdSet set "l"
	val tv       = NT.mk_variable_term v
	val tl       = NT.mk_variable_term l
	(* msg: <atom, value> *)
	val msg      = NT.mk_nuprl_make_authentic_msg_term atm tv
	(* pair: <loc, <atom, value>> *)
	val pair     = NT.mk_nuprl_mk_msg_interface_term tl msg
	(* lam: \value. <loc, <atom, value>> *)
	val lam      = NT.mk_lambda_term v pair
...
fun mk_bsign_function context set ident atm typ hdr =
    let val id       = A.getIdIdent ident ^ "'bsign"
	val lab      = A.getLabel ident
	val v        = A.newIdIdSet set "z"
	val l        = A.newIdIdSet set "l"
	val ls       = A.newIdIdSet set "locs"
...
fun toNuprlTerm context (term as A.N {kind = (A.SCON, A.SCON_INT),    label, value, regions, parents, children = []}) = double (NT.mk_nuprl_int_from_string value)
    ...
    (case value of
	 ...
	 (case get_arity_context_op context value of
		 ...
		 | SOME (params, b) =>
		   let val a_terms = map NT.mk_variable_term params
		       val _       = addDecFPList params
		       val uterm   = mk_nuprl_user_term value a_terms b
  ...
  | toNuprlTerm context (term as A.N {kind = (A.EXP, A.EXP_OP),       label, value, regions, parents, children = [e1, e2]})      =
	...
	fun addTypCls f =
		...
		val t1  = toNuprlIty_em 8 default_force context (E.stripIty ity)
    ...
    in case value of
	 ...
	 | "@"      =>
	   let val cls  = NT.mk_nuprl_class_at_term nt1 nt2
	       val prog = NT.mk_nuprl_class_at_program_term pr1 pr2
	   in (cls, prog)
	   end
	 | "||"     =>
	   let val cls  = NT.mk_nuprl_parallel_class_term nt1 nt2
	       val prog = NT.mk_nuprl_parallel_class_program_term pr1 pr2
	   in (cls, prog)
	   end
	 | ">>="    => raise Fail "mbind:op"
	 | "until"  =>
	   let val cls  = NT.mk_nuprl_until_class_term nt1 nt2
	       val prog = NT.mk_nuprl_until_class_program_term pr1 pr2
	   in (cls, prog)
	   end
	 | "before" =>
	 ...
	 | "?"      =>
	   let val cls  =
	       ...
	       val prog = raise Fail "toNuprl:op:?:newprog"
	   in (cls, prog)
	   end
	   ...
	   (case get_arity_context_op context value of
		...
		(case getUserFP (is_bound_context context) value of
		   ...
		   | SOME (params, b) =>
		     let val a_terms = map NT.mk_variable_term params
			 val _       = addDecFPList params
			 val func    = mk_nuprl_user_term value a_terms b
  ...
  | toNuprlTerm context (term as A.N {kind = (A.EXP, A.EXP_LET),      label, value, regions, parents, children = [b, e]})        =
    (case b of
	 ...
	 in (NT.mk_nuprl_let_term id nte nt,
	     ...
	     else if is_cbv_context context
	     then NT.mk_callbyvalue_term pre (id, pr)
  ...
  | toNuprlTerm context (term as A.N {kind = (A.EXP, A.EXP_BINDING),  label, value, regions, parents, children = [e1, p, e2]})   =
    (case A.getIdPat p of
	 ...
	 let val (nt1,pr1) = toNuprlTerm context e1
	     ...
	     val prog      = NT.mk_nuprl_bind_class_program_term pr1 lam
	 in (cls, prog)
	 end
  ...
  | toNuprlTerm context (term as A.N {kind = (A.EXP, A.EXP_N2I),      label, value, regions, parents, children = [e]})           = toNuprlTerm context e
  ...
  | toNuprlTerm context (term as A.N {kind = (A.ATEXP, A.ATEXP_PRIOR),   label, value, regions, parents, children = [e]})      =
	...
	val prog = raise Fail "toNuprl:op:prior:newprog"
    in (cls, prog)
    end
  ...
  | toNuprlTerm context (term as A.N {kind = (A.ATEXP, A.ATEXP_ONCE), label, value, regions, parents, children = [e]}) =
	...
	val prog = NT.mk_nuprl_once_class_program_term pre
    in (cls, prog)
    end
  | toNuprlTerm context (term as A.N {kind = (A.ATEXP, A.ATEXP_SENDOC), label, value, regions, parents, children = [e]}) =
    let val (nte, pre) = toNuprlTerm context e
	val cls  = NT.mk_nuprl_return_loc_bag_class_term nte
	val prog = NT.mk_nuprl_return_loc_bag_class_program_term pre
    in (cls, prog)
    end
  | toNuprlTerm context (term as A.N {kind = (A.ATEXP, A.ATEXP_ONLOC), label, value, regions, parents, children = [e]}) =
	...
	val prog = NT.mk_nuprl_on_loc_class_program_term pre
    in (cls, prog)
    end
  | toNuprlTerm context (term as A.N {kind = (A.ATEXP, A.ATEXP_LOCAL), label, value, regions, parents, children = [e1,e2,e3]}) =
    let val (nte1, pre1) = toNuprlTerm context e1
	val (nte2, pre2) = toNuprlTerm context e2
	val (nte3, pre3) = toNuprlTerm context e3
	val cls  = NT.mk_nuprl_base_process_class_term nte1 nte2 nte3
	val prog = NT.mk_nuprl_base_process_program_term pre1 pre2 pre3
    in (cls, prog)
    end
  | toNuprlTerm context (term as A.N {kind = (A.ATEXP, A.ATEXP_SKIP), label, value, regions, parents, children = [e]}) =
	...
	val prog = raise Fail "toNuprl:op:skip:newprog"
    in (cls, prog)
    end
  | toNuprlTerm context (term as A.N {kind = (A.ATEXP, A.ATEXP_STATEC), label, value, regions, parents, children}) =
    (case map (toNuprlTerm context) children of
	 ...
	 let val cls  = NT.mk_nuprl_state_class1_term nte1 nte2 nte3
	 ...
	 let val cls  = NT.mk_nuprl_state_class2_term nte1 nte2 nte3 nte4 nte5
	 ...
	 let val cls  = NT.mk_nuprl_state_class3_term nte1 nte2 nte3 nte4 nte5 nte6 nte7
	 ...
	 let val cls  = NT.mk_nuprl_state_class4_term nte1 nte2 nte3 nte4 nte5 nte6 nte7 nte8 nte9
	     val prog = NT.mk_nuprl_state_class4_program_term pre1 pre2 pre3 pre4 pre5 pre6 pre7 pre8 pre9
	 in (cls, prog)
	 end
       | [(nte1, pre1), (nte2, pre2), (nte3, pre3), (nte4, pre4), (nte5, pre5), (nte6, pre6), (nte7, pre7), (nte8, pre8), (nte9, pre9), (nte10, pre10), (nte11, pre11)] =>
	 let val cls  = NT.mk_nuprl_state_class5_term nte1 nte2 nte3 nte4 nte5 nte6 nte7 nte8 nte9 nte10 nte11
	     val prog = NT.mk_nuprl_state_class5_program_term pre1 pre2 pre3 pre4 pre5 pre6 pre7 pre8 pre9 pre10 pre11
	 in (cls, prog)
	 end
  ...
  | toNuprlTerm context (term as A.N {kind = (A.ATEXP, A.ATEXP_MEMORYC), label, value, regions, parents, children}) =
    (case map (toNuprlTerm context) children of
	 [(nte1, pre1), (nte2, pre2), (nte3, pre3)] =>
	 let val cls  = NT.mk_nuprl_memory_class1_term nte1 nte2 nte3
	     val prog = NT.mk_nuprl_memory_class1_program_term pre1 pre2 pre3
	 in (cls, prog)
	 end
       | [(nte1, pre1), (nte2, pre2), (nte3, pre3), (nte4, pre4), (nte5, pre5)] =>
	 let val cls  = NT.mk_nuprl_memory_class2_term nte1 nte2 nte3 nte4 nte5
	     val prog = NT.mk_nuprl_memory_class2_program_term pre1 pre2 pre3 pre4 pre5
	 in (cls, prog)
	 end
       | [(nte1, pre1), (nte2, pre2), (nte3, pre3), (nte4, pre4), (nte5, pre5), (nte6, pre6), (nte7, pre7)] =>
	 let val cls  = NT.mk_nuprl_memory_class3_term nte1 nte2 nte3 nte4 nte5 nte6 nte7
	     val prog = NT.mk_nuprl_memory_class3_program_term pre1 pre2 pre3 pre4 pre5 pre6 pre7
	 in (cls, prog)
	 end
       | [(nte1, pre1), (nte2, pre2), (nte3, pre3), (nte4, pre4), (nte5, pre5), (nte6, pre6), (nte7, pre7), (nte8, pre8), (nte9, pre9)] =>
	 let val cls  = NT.mk_nuprl_memory_class4_term nte1 nte2 nte3 nte4 nte5 nte6 nte7 nte8 nte9
  ...
  | toNuprlTerm context (term as A.N {kind = (A.ATEXP, A.ATEXP_TYPE), label, value, regions, parents, children = [typ]}) =
    let val ity = getItyAtLab context label ("We should have generated a type for type expressions(1)\n" ^ A.toString term)
    in double (toNuprlIty_em 12 default_force context (E.stripIty ity))
    end
  ...
  | toNuprlTerm context (term as A.N {kind = (A.PROP, A.PROP_EXP), label, value, regions, parents, children = [exp]})          =
	...
	val ity = getItyAtLab context label "We should have generated a type for type expressions(2)"
  ...
  | toNuprlTerm context (term as A.N {kind = (A.PROP, A.PROP_ALL), label, value, regions, parents, children = [seq, typ, prp]}) =
	...
	val typ       = toNuprlIty_em 19 default_force context (E.stripIty ity)
...
fun toNuprlData context data n len (A.N {kind = (A.DATA, A.DATA_CONS), label, value, regions, parents, children = [id, typ]}) =
	...
	val typ    = toNuprlIty_em 17 default_force context (E.stripIty ity)
	...
	val tdata  =
		...
		in mk_nuprl_user_term name a_terms false
		end
...
fun toNuprlIncparm context (A.N {kind = (A.INCPARM, A.INCPARM_EXP), label, value, regions, parents, children = [id, exp]}) =
  ...
  | toNuprlIncparm context (A.N {kind = (A.INCPARM, A.INCPARM_TYP), label, value, regions, parents, children = [id, typ]}) =
    let val ity = getItyAtLab context label "We should have generated a type for this message"
	val nty = toNuprlIty_em 17 default_force context (E.stripIty ity)
...
fun mk_component id kind ident mk kinds atm hdr ity context set =
    ...
    in if isAccessed lab id
	  ...
	  List.exists (fn x => kind = x) kinds
       then let	val typ = toNuprlIty_em 20 default_force context (E.stripIty ity)
...
fun toNuprlDec context doc (term as A.N {kind = (A.DEC, A.DEC_LET), label, value, regions, parents, children = [b]}) =
  ...
  | toNuprlDec context doc (term as A.N {kind = (A.DEC, A.DEC_CLASSREC), label, value, regions, parents, children = [f, arg, X, Y]}) =
	...
	val typ       = toNuprlIty_em 20 default_force context (E.stripIty ity)
	...
	val (ny',py') = let val (x,T) = NT.dest_lambda 12 ny
			    ...
			    val pskip = raise Fail "toNuprl:op:classrec:newprog"
	...
	val recbind   = raise Fail "toNuprl:op:classrec:newprog"
  ...
  | toNuprlDec context doc (term as A.N {kind = (A.DEC, A.DEC_QMSG), label, value, regions, parents, children = [ident, hdr, typ]}) =
	...
	val idv  = A.getIdIdent ident ^ "'verify"
	val ida  = A.getIdIdent ident ^ "'sign"
	val idba = A.getIdIdent ident ^ "'bsign"
	...
	val (terms6, progs6) = mk_component idv  value ident mk_verify_class        kinds1 atm hdr ity context set
	val (terms7, progs7) = mk_component ida  value ident mk_sign_function       kinds2 atm hdr ity context set
	val (terms8, progs8) = mk_component idba value ident mk_bsign_function      kinds2 atm hdr ity context set
	val progs    = progs1 @ progs2 @ progs3 @ progs4 @ progs5 @ progs6 @ progs7 @ progs8
	val context' = add_prog_list_context context progs
	val terms    = terms1 @ terms2 @ terms3 @ terms4 @ terms5 @ terms6 @ terms7 @ terms8
    in (terms, context', NONE)
    end
  ...
  | toNuprlDec context doc (term as A.N {kind = (A.DEC, A.DEC_MAIN),    label, value, regions, parents, children = [exp]})            =
	...
	val name     = "main"
	val prod     = NT.mk_nuprl_interface_term (mk_nuprl_hidden_msg_fun_def 17)
	val cls      = NT.mk_nuprl_class_term (mk_nuprl_hidden_msg_fun_def 18) prod
	...
	(* lc is a (nuprl_term option) where the nuprl_term is the abstraction of the program *)
	val progop   = SOME (params,pr',aid,lc)
	val _        = resetDecFP ()
    ...
    then let val name   = A.getIdIdent id
		 ...
		 let val ity = getItyAtLab context label "toNuprlDec:no-type-for-invariant"
			 ...
			 E.foldrITVS
			     ...
			     (E.getItyvarsIty ity)
		     val add = true
		     val nty = toNuprlIty 16 mk_force_var add context IDENTS.empty (E.stripIty ity) ren E.emptyETVS
		 in (nty, ren)
		 end
	     val (pairs, nty) =
  ...
  | toNuprlDec context doc (term as A.N {kind = (A.DEC, A.DEC_INCLUDE), label, value, regions, parents, children = [ident, parms]}) =
    ...
    in case get_fprog_context id context of
	   SOME (pref, params, prog, classabs, SOME progabs) =>
	   let val _            = print ("[inclusion: prefix " ^ pref ^ ", parameters [" ^ String.concatWith "," params ^ "]]\n")
	       (* params_map is the mapping from parameter names to terms
		* given by the include declaration *)
	       val params_map0  = toNuprlIncparms context parms
	       (* We add the hidden_msg_fun parameter *)
	       val mf           = !hidden_msg_fun
	       val nmf          = NT.mk_variable_term mf
	       val emf          = A.mk_new_term A.ID_VID mf [] []
	       val params_map   = (1, mf, nmf, emf, nmf) :: params_map0
	       fun find var = List.find (fn (_, id, _, _, _) => var = id) params_map
	       (* vars_abs are the parameters needed to build the main class
		* of the included spec *)
	       val vars_abs     = List.map (fn rt => NT.dest_variable (NT.rterm2term rt)) (NT.subterms classabs)
	       (* vars_prog are the parameters needed to build the main program
		* of the included spec *)
	       val vars_prog    = List.map (fn rt => NT.dest_variable (NT.rterm2term rt)) (NT.subterms progabs)
	       (* class_args are the actual arguments of the instance of the main
		* class we include *)
	       val class_args   =
		   List.map (fn v =>
				case find v of
				    SOME (n, id, nterm, eterm, pterm) => nterm
				  | NONE => raise Fail ("INCLUDE:no binding for " ^ v))
			    vars_abs
	       (* prog_args are the actual arguments of the instance of the main
		* program we include *)
	       val prog_args    =
		   List.map (fn v =>
				case find v of
				    SOME (n, id, nterm, eterm, pterm) => pterm
				  | NONE => raise Fail ("INCLUDE:no binding for " ^ v))
			    vars_prog
	       val main_class   = pref ^ "_main"
	       val main_prog    = pref ^ "_main-program"
	       (* We add the free parameters (local) of the values of the
		* parameters of the included spec to the list of parameters
		* of the current declaration *)
	       ...
	       val class_inst   = mk_nuprl_user_term main_class class_args true
	       (* instance of the main program *)
	       val prog_inst    = mk_nuprl_user_term main_prog prog_args true
	       val exp          = dummy_dot_term
	       (* schemeop is the type of the class we're building *)
	       val prod         = NT.mk_nuprl_interface_term (mk_nuprl_hidden_msg_fun_def 19)
	       val cls          = NT.mk_nuprl_class_term (mk_nuprl_hidden_msg_fun_def 20) prod
	       val schemeop     = SOME (cls, [])
	       val premises     = []
	       val programmable = true
	       val localclass   = SOME (form_prog_subst context prog_inst)
	       val data         = false
	       val lvlop        = NONE
	       val (aid,lc,ab,th,rest,_) =
		   genAbstractionAndWF
	       ...
	       val ab'          = addDoc doc ab
	       val _            = resetDecFP ()
	       val uid          = get_user_name main_class
	       val context1     = add_maybe_state_context context uid class_inst
	       val th'          =
		   if is_export_context context id
		   then let val prp  = NT.mk_nuprl_iproperty_term "EventML_export" (NT.mk_nuprl_ibool_term true)
			    val cons = NT.mk_nuprl_icons_cons_term prp NT.mk_nuprl_icons_nil_term
	       ...
	       val context2 = add_prog_op_context context1 uid lc prog_inst
	       val context3 = add_dec_context context2 uid ab
	   in (ab' :: th' :: rest, context3, NONE)
	   end
	 | _ => raise Fail "INCLUSION:couldn't find an entry for that inclusion"
    (*([], context, NONE)*)
    end
...
fun isClassScheme (E.VPOLY (bounds, (cssh, ity))) = E.isItyClass ity
  | isClassScheme _ = false
...
fun getParamsFromTerm term context =
	...
	let val id       = A.getIdIdent ident
	    ...
	    val _        = print ("[found set parameter: " ^ id ^ "]\n")
	    val context2 = add_param_context context1 id sch (PK_SET NONE)
	in context2
	end
      | A.N {kind = (A.DEC, A.DEC_PMAP), label, value, regions, parents, children = [ident, typ1, typ2]} =>
	let val id       = A.getIdIdent ident
	    val lab      = A.getLabel ident
	    ...
	    (* We add to the context the fact that id is a parameter
	     * with type scheme 'sch' *)
	    val _        = print ("[found map parameter: " ^ id ^ "]\n")
	...
	let val id       = A.getIdIdent ident
	    ...
	    val _        = print ("[found regular parameter: " ^ id ^ " (class?" ^ Bool.toString (isClassScheme sch) ^ ")]\n")
	    (* we add to the context the fact that id has name id and
	     * does not take any argument *)
	    val context1 = add_arity_context context id id []
	    (* We add to the context the fact that id is a parameter
...
fun getTypesFromTerm term context =
	...
	let val name  = A.getIdIdent id
		...
		foldr (fn (con, disju) =>
			  let val lab = A.getLabel con
			      ...
			      val add = true
			      val typ = toNuprlIty 18 default_force add context (IDENTS.singleton name) (E.stripIty ity) BTV.empty E.emptyETVS
			  in case disju of
				 NONE => SOME typ
	...
	let val name     = A.getIdIdent tycon
	    ...
	    val addctxt  = true
	    val nty      = toNuprlIty 19 default_force addctxt context IDENTS.empty (E.stripIty ity) BTV.empty E.emptyETVS
	    ...
	    val abstyp   = mk_nuprl_user_term name n_params false
...
fun (*generateHeaders context [] label = NONE
  |*) generateHeaders context hdrs label =
	...
	val _ = print ("[--no rep of the headers]\n")
	...
	val _ = print ("[--headers types]\n")
	val hdrsp =
	    map (fn (kind, n_hdr, typ, e_hdr) =>
		    let val ity = E.stripIty typ
			val _ = print ("[----header: " ^ NT.toStringTerm n_hdr ^ ", " ^ E.ppIty' ity ^ "]\n")
		    in (n_hdr, toNuprlIty_em 7 mk_force_mf context ity)
		    end)
		hdrs
	...
	val _ = print ("[--function from headers to types]\n")
	...
	val _ = print ("[--type extension of msg interface]\n")
	...
	val n_lst_types =
	    foldr (fn ((kind, n_hdr, typ, e_hdr), lst) =>
		      if kind = "input"
		      then lst
		      else let val nty  = toNuprlIty_em 7 default_force context (E.stripIty typ)
			       val pair = NT.mk_pair_term n_hdr nty
			   in NT.mk_nuprl_cons_term pair lst
			   end)
		  (NT.mk_nuprl_nil_term)
		  hdrs
	val _ = print ("[--not input headers with types]\n")
	...
	(* no input headers id *)
	val n_id_noinputs = mk_nuprl_user_term name_noinputs [] false
...
fun getHeadersNoInputs (SOME (e_hdrs_no_inputs, _, _, objs)) =
...
fun generateStdMa context (e_hdrs, n_hdrs) term =
    (case A.getKind term of
	 ...
	 (case A.getChildren term of
		  ...
		  val constraint      = NT.mk_nuprl_eo_msg_interface_constraint_term (mk_nuprl_hidden_event_ordering ()) nt n_hdrs (mk_nuprl_hidden_msg_fun_def 21)
		  val delivered       = NT.mk_nuprl_eo_msgs_interface_delivered_term (mk_nuprl_hidden_event_ordering ()) nt (mk_nuprl_hidden_msg_fun_def 22)
...
fun toNuprlFile context (term as A.N {kind = (A.FILE, A.FILE_F), label, value, regions, parents, children}) =
	...
	val _        = print ("[getting parameters]\n")
	...
	val stdma    = generateStdMa context4 (getHeadersNoInputs hop) term
	val extra    = h' @ stdma
...
fun form_prog context NONE = NONE
  | form_prog context (SOME (params, prog, classabs, progabs)) =
    (* It might be better to just get the parameters in the order in which
     * they occur in the spec. *)
    SOME (params, NT.mk_nuprl_lambdas_term params prog)
...
(* NOTE: newprog is not used anymore *)
fun toNuprl mapop file obid term env sub addpref poly pextra btyp cbva cbv newprog =
	...
	val ctxt12  = set_cbv_context     ctxt11 cbv
	val solved  = EN.solver env sub
	val _       = setUnifEnv solved
	(* test: *)
	(*val ity = getItyAtLab ctxt12 60398 "foobar"*)
