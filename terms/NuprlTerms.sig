...
signature NUPRL_TERMS = sig
    ...
    val mk_nuprl_make_authentic_msg_term           : nuprl_term -> nuprl_term -> nuprl_term
    ...
    val mk_nuprl_base_process_class_term           : nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term
    val mk_nuprl_base_process_program_term         : nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term
    val mk_nuprl_eo_msgs_interface_delivered_term  : nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term
    ...
    val mk_nuprl_eo_msg_interface_constraint_term  : nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term
    ...
    val mk_nuprl_state_class5_term                 : nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term
    val mk_nuprl_state_class5_program_term         : nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term -> nuprl_term
    ...
    val get_free_vars : nuprl_term -> string list
