...
let is_canonical_term term =
  is_nuprl_lambda_term              term
    or is_nuprl_pair_term           term
    or is_nuprl_inl_term            term
    or is_nuprl_inr_term            term
    or is_nuprl_axiom_term          term
    or is_nuprl_natural_number_term term
    or opid_of_term term = "token"
